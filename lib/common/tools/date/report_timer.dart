...
import '../share_preference/share_preference.dart';

class ReportTimer {
  static final int reportSeconds = 5 * (Config.DEBUG ? 12 : 12);
  static Timer? _timer;
  ...
  static Future startReportTimer(BuildContext context,
    ...
    int timeRemain = reportSeconds - timeElapsed;
    reportRunnable(null);
  ...
  static void reportRunnable(Timer? timer) async {
    ...
    if (reportTime.result && reportTime.model != null && reportTime.model.code == 1 && reportTime.model.data != null) {
