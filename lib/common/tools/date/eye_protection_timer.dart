...
import 'package:my_gallery/modules/widgets/alert/eye_protect_dialog_widget.dart';
...
class EyeProtectionTimer {
  static final int eyeProtectionSeconds = 20 * 60;
  static Timer? _timer;
  ...
  static Future startEyeProtectionTimer(BuildContext context,
    ...
    int timeRemain = eyeProtectionSeconds - timeElapsed;
