          ...
          child: Row(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text(
                  subjects.entries.where((s) => s.key == course.subjectId).first.value,
                  style: TextStyle(fontSize: 13, color: Color(MyColors.primaryValue)),
                ),
