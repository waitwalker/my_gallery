...
abstract class AutoScrollController implements ScrollController {
  ...
  Map<int?, DiagnosisAutoScrollTagState> get tagMap;
...
mixin AutoScrollControllerMixin on ScrollController
  ...
  @override
  final Map<int?, DiagnosisAutoScrollTagState> tagMap = <int?, DiagnosisAutoScrollTagState>{};
...
class DiagnosisAutoScrollTag extends StatefulWidget {
  ...
  @override
  DiagnosisAutoScrollTagState createState() {
    return new DiagnosisAutoScrollTagState<DiagnosisAutoScrollTag>();
  }
}

Map<DiagnosisAutoScrollTagState, AnimationController?> _highlights =
    <DiagnosisAutoScrollTagState, AnimationController?>{};

class DiagnosisAutoScrollTagState<W extends DiagnosisAutoScrollTag> extends State<W>
