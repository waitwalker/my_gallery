...
abstract class ChapterAutoScrollController implements ScrollController {
  factory ChapterAutoScrollController(
      {double initialScrollOffset: 0.0,
        ...
        Axis? axis,
        String? debugLabel,
        ChapterAutoScrollController? copyTagsFrom}) {
  ...
  Map<int?, ChapterAutoScrollTagState> get tagMap;
...
implements ChapterAutoScrollController {
  @override
  final Map<int?, ChapterAutoScrollTagState> tagMap = <int?, ChapterAutoScrollTagState>{};
...
class ChapterAutoScrollTag extends StatefulWidget {
  final ChapterAutoScrollController? controller;
  final int? index;
  final Widget child;
  final Color? color;
  ...
  @override
  ChapterAutoScrollTagState createState() {
    return ChapterAutoScrollTagState<ChapterAutoScrollTag>();
  }
}

Map<ChapterAutoScrollTagState, AnimationController?> _highlights =
<ChapterAutoScrollTagState, AnimationController?>{};

class ChapterAutoScrollTagState<W extends ChapterAutoScrollTag> extends State<W>
