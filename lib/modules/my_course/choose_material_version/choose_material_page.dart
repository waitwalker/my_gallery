...
import 'package:my_gallery/model/material_list_model.dart';
...
class ChooseMaterialPage extends StatefulWidget {
  ...
  ChooseMaterialPage({this.type = 2, this.subjectId, this.gradeId, this.materialId, this.materialDataEntity});
...
class _ChooseMaterialPageState extends State<ChooseMaterialPage> {
  ...
  void initState() {
    ...
    print("${widget.materialDataEntity}");
    ...
    response.then((r) {
      ...
      late int currentVersionIndex;
      late int currentMaterialIndex;
      ...
      for (int i = 0; i < data!.data!.length; i ++) {
        ...
        if (material.versionName == widget.materialDataEntity!.defVersionName) {
          ...
          for (int j = 0; j < material.teachingMaterialDTOList!.length; j++) {
            ...
            if (teachingMaterialDTOListEntity.materialId == widget.materialDataEntity!.defMaterialId) {
