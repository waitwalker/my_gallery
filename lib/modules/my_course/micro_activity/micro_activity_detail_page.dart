...
class _MicroActivityDetailPageState extends State<MicroActivityDetailPage> {
  ...
  void _onTapItem(CourseList course,{required List<CourseList> courses,required int index}) async {
    /// 微课
    var microCourseResourseInfo = await CourseDaoManager.getMicroCourseResourceInfo(course.resourceId);
  ...
  void _toMicroCourse(
    ...
    Navigator.of(context).push(MaterialPageRoute(builder: (_) {
      return MicroCoursePage(data, courseId: courseId, from: nodeName,fromCollegeEntrance: true,);
    }));
  }
}
