...
class _JuniorDetailState extends State<UnionDetailPage> {
        ...
        Padding(padding: EdgeInsets.only(right: 13.5,),
          child: Container(
            ...
            child: ElevatedButton(
              ...
              child: Text("${version.registerCourseName}",style: TextStyle(fontSize: 13,color: version.isSelected ? Color(0xffFFFFFF) : Color(0xff3A3A3A))),
              style: ButtonStyle(
  ...
  void _toMicroCourse(
    ...
    Navigator.of(context).push(MaterialPageRoute(builder: (_) {
      return MicroCoursePage(data, courseId: courseId, from: nodeName, fromCollegeEntrance: true, hideXueAn: false,);
    }));
  }
}
