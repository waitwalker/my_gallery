...
/// @description 2020国庆中秋营销活动
/// @author waitwalker
/// @date 2020/9/25
///
class AutumnFestivalPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _AutumnFestivalState();
  }
}

class _AutumnFestivalState extends State<AutumnFestivalPage> {
  @override
  ...
  List < Map<String,dynamic>> tmpImages = [
    {
      "image" : "static/images/autumn_junior_1_math.jpg",
      "type":0,
      "title":"初一数学",
    },
    {
      "image" : "static/images/autumn_junior_2_chinese.jpg",
      "type":1,
      "title":"初二语文",
    },
    {
      "image" : "static/images/autumn_junior_3_english.jpg",
      "type":2,
      "title":"初三英语",
    },
    {
      "image" : "static/images/autumn_senior_1_math.jpg",
      "type":3,
      "title":"高一数学",
    },
    {
      "image" : "static/images/autumn_senior_2_physics.jpg",
      "type":4,
      "title":"高二物理",
    },
    {
      "image" : "static/images/autumn_senior_3_english.jpg",
      "type":5,
      "title":"高三英语",
    },
  ];
  ...
  Widget _itemBuilderContext(BuildContext context, int index) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        ...
        String url = Config.DEBUG ? "http://huodongt.etiantian.com/zhitongche/indexm.html?token=" : "https://huodong.etiantian.com/jingying/indexm.html?token=";
        String typeStr = "&type=$type";
        String fullUrl = "$url$token$typeStr";
        Navigator.of(context).push(MaterialPageRoute(builder: (_) {
          return CommonWebviewPage(initialUrl: fullUrl, title: title,);
        }));
      },
    );
  }
