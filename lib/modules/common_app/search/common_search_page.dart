...
class _CommonSearchState extends State<CommonSearchPage> {
  ...
  proxyValue() async {
    ...
    print(_isIOSCanDebug);
    bool? _isDeviceLongBright = sharedPreferences.getBool("isDeviceLongBright");
    bool? _isShowUserPrivacy = sharedPreferences.getBool("userPrivacy");
    ...
    if (_isShowUserPrivacy != null) {
      setState(() {
        isShowUserPrivacy = !_isShowUserPrivacy;
      });
    }
  }
            ...
            child: Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  CupertinoSwitch(
                    activeColor: Color(0xFF52D257),
                    value: isShowUserPrivacy,
                    onChanged: (bool current) async {
                      isShowUserPrivacy = current;
                      if (isShowUserPrivacy) {
                        SharedPrefsUtils.put('userPrivacy', false);
                      } else {
                        SharedPrefsUtils.put('userPrivacy', true);
                      }
                      setState(() {
                      });
                    },
