...
import 'package:my_gallery/modules/common_app/home/navigation_transition_page.dart';
    ...
    return InkWell(
      ...
      onTap: () {
        ...
        if (index == 1 - tmp) {
          ...
          Navigator.push(context, PageTransition(type: PageTransitionType.topToBottom, child: CommonNavigationTransitionPage()));
        } else if (index == 5 - tmp) {
          Navigator.push(context, PageTransition(type: PageTransitionType.bottomToTop, child: CommonNavigationTransitionPage()));
        } else if (index == 6 - tmp) {
