...
// import 'package:microcosm/common/components/app_update/app_install_manager.dart';
// import 'package:microcosm/common/components/app_update/update_dialog.dart';
...
// import 'package:microcosm/common/interface/statistics_manager.dart';
...
// }
//
// class _HomePage extends State<HomeIndex> with SingleTickerProviderStateMixin, RouteAware {
//   /// 弹窗队列
...
//
//   /// 主模块动画大小
//   late double mainModuleAnimateSize = 50;
//
//   /// 子模块动画大小
//   late double subModuleAnimateSize = 30;
//
//
...
//     routeObserver.subscribe(this, ModalRoute.of(context) as Route); //订阅
//     super.didChangeDependencies();
//   }
//
//   @override
//   void didPushNext() {
//     Log.i("------> home page didPushNext");
//     StatisticsManager().isHomePage = false;
//     super.didPushNext();
//   }
//
//   @override
//   void didPopNext() {
//     Log.i("------> home page didPopNext");
//     StatisticsManager().isHomePage = true;
//     super.didPopNext();
//   }
//
//   /// methodName _onCancel
//   /// description 取消订阅
...
//       GuideLayout.showGuide(
//         context,
//         _children,
//         completedCallBack,
//         guideButtonList:
//         Provider.of<HomeModel>(context, listen: false).guideButtonList,
//       );
//     }
//   }
//
...
//           dialog = UpdateDialog.showForceUpdate(context,
...
//           ];
//           HomeSourceDataManager.exposureAppUpdateModule(paramArray: para);
//           dialog = UpdateDialog.showUnforcedUpdate(context, updateContent: Provider.of<HomeModel>(context, listen: false)
//               .updateBeanEntity
//               .description,
//               onUpdate: (){
//                 HomeSourceDataManager.clickAppUpdateModule(
...
//             Provider.of<HomeModel>(context, listen: false)
//                 .unitySilentDownload();
//             AppInstallManager.install(apkPath: path + '/' + apkName);
//           } else {
...
//     return Selector<HomeModel, CommonPageStatus>(
//       builder: (ctx, pageStatus, child) {
//         /// 页面加载中状态
//         if (pageStatus == CommonPageStatus.Loading) {
//           return Scaffold(
...
//
//         /// 页面加载错误状态
//         if (pageStatus == CommonPageStatus.Error) {
//           return Scaffold(
//             backgroundColor: AppColors.colorWhite,
//             appBar: AppBarCustom(
//               toolbarHeight: 0,
...
//                           Padding(
//                             padding: EdgeInsets.only(left: 15, right: 15),
//                             child: Selector<HomeModel, List<HomeItemBeanEntity>>(
//                                 builder: (ctx, mainModuleList, child) {
//                                   return mainModuleList.isNotEmpty
//                                       ? _mainModuleBuilder(
//                                       list: mainModuleList)
//                                       : Container();
//                                 }, selector: (ctx, model) {
//                               return model.mainModuleList;
//                             }),
//                           ),
//
//                           /// 子模块入口
...
//                             child: Selector<HomeModel, List<HomeItemBeanEntity>>(
//                                 builder: (ctx, subModuleList, child) {
//                                   return subModuleList.isNotEmpty
//                                       ? Column(
//                                     crossAxisAlignment:
...
//                                       ),
//                                       _subModulePage(
//                                           gameList: subModuleList),
//                                     ],
//                                   )
//                                       : Container();
//                                 }, selector: (ctx, model) {
//                               return model.subModuleList;
//                             }),
//                           ),
//                         ],
//                       ),
...
//
//             /// 悬浮按钮
//             Selector<HomeModel, List<HomeItemBeanEntity>>(builder: (ctx, floatingButtons, child) {
//               return floatingButtons.isNotEmpty
//                   ? FloatBox(
...
//                 iconUrl: floatingButtons.first.iconUrl,
//                 onTap: () {
//                   /// 悬浮按钮点击
//                   HomeSourceDataManager.clickSingleModule(
//                       eventId: HomeSourceDataManager.floatButtonClick,
//                       elementId: floatingButtons.first.id);
//                   CommonEventManager.handleEvent(
//                       itemBeanEntity: floatingButtons.first);
//                 },
//               )
//                   : Container();
//             }, selector: (ctx, model) {
//               return model.floatingButton;
//             }),
//           ],
//         );
//       },
...
//                     ),
//                   ),
//                   child: _builderDownloadAnimate(
//                     itemBeanEntity: oneModuleFirst,
//                     size: mainModuleAnimateSize,),
//                 )
//                     : Container(),
//               ],
//             ),
...
//   }
//
//   /// methodName _builderDownloadAnimate
//   /// description Unity加载动画组件
//   /// date 2022/7/28 17:11
//   /// author LiuChuanan
//   Widget _builderDownloadAnimate({
//     required HomeItemBeanEntity itemBeanEntity,
//     required double size,
//     int moduleIndex = 1,
//   }) {
//     if (itemBeanEntity.downloadStatus == 1) {
//       return moduleIndex == 1 ? Column(
...
//           SizedBox(height: 3,),
//           Text(" ",
//             style: TextStyle(fontSize: size > 30 ? 11 : 7, color: AppColors.colorWhite,),
//             maxLines: 1,
//           )
//         ],
//       ) :Column(
...
//           SizedBox(height: 13,),
//           _downloadProgress(
//               itemBeanEntity.progress / 100.0, size: size),
//           SizedBox(height: 3,),
//           Text(itemBeanEntity.downloadString,
//             style: TextStyle(fontSize: size > 30 ? 11 : 7, color: AppColors.colorWhite,),
//             maxLines: 1,
//           )
//         ],
...
//   /// author LiuChuanan
//   Widget _downloadProgress(double progress, {double size = 30}) {
//     return DownloadProgress(
//       progress: progress,
//       fillColor: AppColors.colorWhite,
//       borderWidth: size > 30 ? 3.5 : 1.5,
//       radius: size,
//     );
//   }
//
...
//     return Selector<HomeModel, HomeItemBeanEntity>(builder: (ctx, itemBean, child){
//       HomeItemBeanEntity gameBeanEntity = itemBean;
//       bool shouldShow = false;
...
//       );
//     },
//       selector: (_, model) => model.subModuleList[index],
//     );
//   }
//
...
//           if (status == 3) {
//             Provider.of<HomeModel>(context, listen: false).refreshPage();
//             Future.delayed(Duration(milliseconds: 100),(){
//               CommonEventManager.handleEvent(
//                   itemBeanEntity: itemBeanEntity, status: 3);
//             });
//           } else {
//             itemBeanEntity.downloadStatus = 1;
//             /// 重置下载状态的数据
//             itemBeanEntity.progress = 0;
//             itemBeanEntity.downloadString = "0.0MB/0.0MB";
//             itemBeanEntity.currentSize = 0;
//             itemBeanEntity.totalSize = 0;
