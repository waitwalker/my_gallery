...
class ShopScrollController extends ScrollController {
  ...
  Future<void> animateTo(
    ...
    final List<Future<void>?> animations = List<Future<void>?>.filled(_positions.length, null, growable: false);
    ...
    return Future.wait<void>(animations as Iterable<Future<void>>).then<void>((List<void> _) => null);
  }
  ...
  @override
  ShopScrollPosition createScrollPosition(ScrollPhysics physics, ScrollContext context, ScrollPosition? oldPosition,) {
