import 'package:my_gallery/modules/widgets/tripledes/src/constants.dart';
import 'package:my_gallery/modules/widgets/tripledes/src/utils.dart';
import 'package:my_gallery/modules/widgets/tripledes/tripledes.dart';
...
class DESEngine extends BaseEngine {
  ...
  void init(bool forEncryption, List<int?> key) {
    ...
    // Assemble 16 subkeys
    var subKeys = this._subKeys = List<List<int>>.generate(16, (_) => []);
  ...
  void exchangeLR(offset, mask) {
    ...
    mask).toSigned(32);
    if (this._rBlock != null) {
      this._rBlock = this._rBlock! ^ t;
    }
    if (this._lBlock != null) {
      this._lBlock = this._lBlock! ^(t<<offset);
    }
    (this._rBlock!).toSigned(32);
    this._lBlock!.toSigned(32);
  }
