...
import 'package:my_gallery/modules/entrance/navigation_route.dart';
...
class _AdvertisementState extends State<AdvertisementPage> {
            ...
            : Container(
                ...
                width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
                    image: DecorationImage(image: (imageFile == null ? AssetImage("static/images/logo.png") : FileImage(imageFile!)) as ImageProvider<Object>,),
                    color: Colors.white,),
                child: Row(
  ...
  void _startLaunchAnimation() {
    ...
    Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.fade, child: LaunchAnimationPage()));
  }
