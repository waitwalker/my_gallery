...
DataEntity _$DataEntityFromJson(Map<String, dynamic> json) {
  return DataEntity(
      ...
      ZLDeclineStatus: json['ZLDeclineStatus'] as num?,
      isCheckPasswordDate: json['isCheckPasswordDate'] as num?,
...
Map<String, dynamic> _$DataEntityToJson(DataEntity instance) =>
    <String, dynamic>{
      ...
      'mobile': instance.mobile,
          'ZLDeclineStatus': instance.ZLDeclineStatus,
      'isCheckPasswordDate': instance.isCheckPasswordDate,
