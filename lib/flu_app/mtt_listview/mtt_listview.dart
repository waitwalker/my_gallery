...
import 'package:my_gallery/flu_app/mtt_listview/mtt_bottom_listview.dart';
import 'package:scrollable_positioned_list/scrollable_positioned_list.dart';

import 'hover_util.dart';
import 'index_bar.dart';
import 'mtt_bottom_listview.dart';


/// AzListView
class MTTListView extends StatefulWidget {
  MTTListView({
    Key? key,
    required this.data,
  ...
  @override
  _MTTListViewState createState() => _MTTListViewState();
}

class _MTTListViewState extends State<MTTListView> {
  ...
  int _getIndex(String? tag) {
    for (int i = 0; i < widget.itemCount; i++) {
      HoverAbstractModel bean = widget.data[i];
      if (tag == bean.getHoverTag()) {
        return i;
      }
    }
    return -1;
    ...
    return Stack(
      children: [
        MTTBottomListView(
          ...
          itemScrollController: itemScrollController,
          itemPositionsListener: itemPositionsListener,
          hoverItemBuilder: widget.hoverItemBuilder,
          hoverItemHeight: widget.hoverItemHeight,
