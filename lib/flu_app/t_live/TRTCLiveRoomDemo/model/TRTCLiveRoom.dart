...
abstract class LTRTCLiveRoom {
  ...
  */
  static Future<LTRTCLiveRoom?> sharedInstance() async {
  ...
  */
  Future<LActionCallback> login(
      int sdkAppId, String userId, String userSig, LTRTCLiveRoomConfig config);

  /*
  * 退出登录
  */
  Future<LActionCallback> logout();
  ...
  */
  Future<LActionCallback> setSelfProfile(String userName, String avatarURL);
  ...
  */
  Future<LActionCallback> createRoom(int? roomId, LRoomParam roomParam);
  ...
  */
  Future<LActionCallback> destroyRoom();
  ...
  * @param roomId 房间标识
  */
  Future<LActionCallback> enterRoom(int? roomId);

  /*
  * 退出房间（观众调用）
  *
  */
  Future<LActionCallback> exitRoom();
  ...
  */
  Future<LRoomInfoCallback> getRoomInfos(List<String?> roomIdList);

  // 获取房间内所有的主播列表，enterRoom() 成功后调用才有效。
  Future<LUserListCallback> getAnchorList();

  // 获取群成员列表。
  Future<LUserListCallback> getRoomMemberList(int nextSeq);
  ...
  // 观众请求连麦。
  Future<LActionCallback> requestJoinAnchor();
  ...
  // 主播踢除连麦观众。
  Future<LActionCallback> kickoutJoinAnchor(String userId);

  // 主播请求跨房 PK。
  Future<LActionCallback> requestRoomPK(int roomId, String userId);

  // 主播响应跨房 PK 请求。
  Future<LActionCallback> responseRoomPK(String userId, bool agree);

  // 退出跨房 PK。
  Future<LActionCallback> quitRoomPK();
  ...
  * @param message 文本消息
  */
  Future<LActionCallback> sendRoomTextMsg(String message);
  ...
  * @param message 文本消息
  */
  Future<LActionCallback> sendRoomCustomMsg(String cmd, String message);
}
