...
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/model/TRTCLiveRoom.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/model/TRTCLiveRoomDelegate.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/FavoriteAnimation.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/FilterSetting.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/LiveImgButton.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/LiveMessageList.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/LiveTextButton.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/MusicSetting.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/PKUserList.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/PopUpMessageList.dart';
import 'package:my_gallery/flu_app/t_live/TRTCLiveRoomDemo/ui/base/SubVideoList.dart';
import 'package:my_gallery/flu_app/t_live/base/YunApiHelper.dart';
import 'package:my_gallery/flu_app/t_live/debug/GenerateTestUserSig.dart';
...
class _LiveRoomPageState extends State<LiveRoomPage> {
  ...
  initTrtc() async {
    trtcLiveCloud = await LTRTCLiveRoom.sharedInstance();
  ...
  initRoomInfo() async {
    ...
    await trtcLiveCloud!.login(
      ...
      LTRTCLiveRoomConfig(useCDNFirst: false),
    );
    if (isNeedCreateRoom!) {
      await createRoom(
          _tpmCurrentRoomId,
      ...
      LActionCallback _actionCallback =
    ...
    LUserListCallback memberListCallback =
    await trtcLiveCloud!.getRoomMemberList(0);
    LUserListCallback anchorListCallback = await trtcLiveCloud!.getAnchorList();
  ...
  getPKList(currLoginUserId, Function? callBack) async {
    if (widget.isAdmin) {
      ...
      LRoomInfoCallback resp = await trtcLiveCloud!.getRoomInfos(roomIdls);
      if (resp.code == 0 && resp.list != null) {
        safeSetState(() {
          pkUserList = resp.list!.where((element) {
  ...
  createRoom(roomId, LRoomParam roomParam) async {
    LActionCallback actionCallback =
  ...
  stopAndGoIndex() async {
    try {
      ...
      if (mounted) {
        ...
        //   "/liveRoom/list",
        // );
        //kFluRouterDelegate.replaceLastPage(name: "/liveRoom/list");
        Navigator.pop(context);
