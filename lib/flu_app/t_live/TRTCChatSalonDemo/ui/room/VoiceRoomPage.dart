...
import 'package:my_gallery/flu_app/t_live/TRTCChatSalonDemo/model/TRTCChatSalonDelegate.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () async {
            bool isOk = (await (this.showExitConfirmDialog() as FutureOr<bool>));
            if (isOk) {
